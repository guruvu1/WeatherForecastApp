...
typealias WeatherViewModel = WeatherView.ViewModel
...
struct WeatherView: View {
    ...
    init(dataSource: WeatherViewModel) {
    ...
    private var todayTempView: some View {
        HStack(alignment: .center, spacing: 8) {
            VStack(alignment: .center, spacing: 8) {
                KFImage(dataSource.conditionIconUrl)
                    .placeholder {
                        ProgressView()
                            .progressViewStyle(.circular)
                            .tint(.white)
                    }
                    .onFailureImage(UIImage(named: "icon_placeholder"))
...
#Preview {
    WeatherView(dataSource: WeatherViewModel(locationName: "", localTime: "", conditionIconUrl: nil, conditionText: "", averageTempC: "", minTemp: "", maxTemp: "", maxWindMph: "", avgHumidity: "", sunrise: "", sunset: ""))
}
