...
struct WeatherDashboardView: View {
    ...
    private func prepareWeatherViewModel(foreCastDay: ForeCastDay) -> WeatherViewModel {
        WeatherViewModel(
    ...
    private func prepareWeatherViewShimmerViewModel() -> WeatherViewModel {
        WeatherViewModel(
...
#Preview {
    WeatherDashboardView(viewModel: WeatherDashboardViewModel(historyIntegrationUseCase: HistoryIntegrationService(networkManager: NetworkManager(baseURL: ""))))
}
